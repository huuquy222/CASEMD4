...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public com.example.casestudy.security.RestAuthenticationEntryPoint restServicesEntryPoint() {
        return new com.example.casestudy.security.RestAuthenticationEntryPoint();
    }

    @Bean
    public AccessDeniedHandler customAccessDeniedHandler() {
        return new com.example.casestudy.security.UserAccessDeniedHandler();
    }
