class App {
    ...
    static renderProduct(product) {
        ...
        let str = `
            ...
            currency: 'VND'
                    ...
                    <td>${product.category.name}</td>
                    <td>
                        <button id="btnUpdate" type="button" class="btn btn-outline-success add_cart" data-id="${product.id}"
                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="#modalUpdate">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button type="button" id="" class="btn btn-outline-danger add_cart" data-id="${product.id}"
    ...
    static renderRowUser(user, role) {
        let str = `
                <tr id="tr_${user.id}">
                    <td>${user.id}</td>
                    <td>${user.phone}</td>
...
class Product {
    constructor(id, name, image, quantity, price, category) {
        this.id = id;
        this.name = name;
        this.image = image;
